...
# Read mute state by matching the friendly name (best-effort)
def read_device_mute_by_name(substring: str) -> bool:
    try:
        ...
        for i in range(count):
            ...
            from comtypes.gen import Propsys    # generated by comtypes at runtime
            from comtypes.gen import _886D8EEB_8CF2_4446_8D02_CDBA1DBDCF99_0_1_0 as PropertyKeyLib
            PKEY_Device_FriendlyName = PropertyKeyLib.PROPERTYKEY(fmtid=GUID('{A45C254E-DF1C-4EFD-8020-67D146A850E0}'), pid=14)

            pv = props.GetValue(PKEY_Device_FriendlyName)
            name = pv.GetValue() or ""
        ...
        pass
    # Fallback to default endpoint if match failed
